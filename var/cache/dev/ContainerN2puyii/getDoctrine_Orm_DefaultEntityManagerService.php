...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/Entity'), 1 => ($this->targetDirs[3].'/src/Engine/ApiBundle/Entity')]);

$b->addDriver($c, 'App\\Entity');
$b->addDriver($c, 'App\\Engine\\ApiBundle\\Entity');

$a->setEntityNamespaces(['App' => 'App\\Entity', 'EngineApiBundle' => 'App\\Engine\\ApiBundle\\Entity']);
