...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'app\\command\\dantestcommand' => 'App\\Command\\DanTestCommand',
            'app\\engine\\apibundle\\controller\\apicontroller' => 'App\\Engine\\ApiBundle\\Controller\\ApiController',
            'app\\engine\\apibundle\\form\\type\\booktype' => 'App\\Engine\\ApiBundle\\Form\\Type\\BookType',
            'app\\engine\\apibundle\\validator\\constraints\\containsalphanumericvalidator' => 'App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator',
        ...
        $this->fileMap = [
            'App\\Command\\DanTestCommand' => 'getDanTestCommandService.php',
            'App\\Engine\\ApiBundle\\Controller\\ApiController' => 'getApiControllerService.php',
            'App\\Engine\\ApiBundle\\Form\\Type\\BookType' => 'getBookTypeService.php',
            'App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator' => 'getContainsAlphanumericValidatorService.php',
        ...
        $this->privates = [
            ...
            'App\\Command\\DanTestCommand' => true,
            'App\\Engine\\ApiBundle\\Form\\Type\\BookType' => true,
            'App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-csyket-Kw', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6cSG-9J0kn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FIYERlmUUE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HXdV1XWLhs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        }, 'App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator' => function () {
            return ${($_ = isset($this->services['App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator']) ? $this->services['App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator'] : ($this->services['App\\Engine\\ApiBundle\\Validator\\Constraints\\ContainsAlphanumericValidator'] = new \App\Engine\ApiBundle\Validator\Constraints\ContainsAlphanumericValidator())) && false ?: '_'};
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'EngineApiBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Engine/ApiBundle'),
                    'namespace' => 'App\\Engine\\ApiBundle',
                ],
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'EngineApiBundle' => 'App\\Engine\\ApiBundle\\EngineApiBundle',
            ],
            ...
            'console.command.ids' => [
                'console.command.app_command_dantestcommand' => 'App\\Command\\DanTestCommand',
