...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Engine\\ApiBundle\\Form\\Type\\BookType' => function () {
    return ${($_ = isset($this->services['App\\Engine\\ApiBundle\\Form\\Type\\BookType']) ? $this->services['App\\Engine\\ApiBundle\\Form\\Type\\BookType'] : ($this->services['App\\Engine\\ApiBundle\\Form\\Type\\BookType'] = new \App\Engine\ApiBundle\Form\Type\BookType())) && false ?: '_'};
